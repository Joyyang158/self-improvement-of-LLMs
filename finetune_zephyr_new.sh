...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=4 --main_process_port 2950 run_spin.py configs/config_zephyr_new.yaml --num_train_epochs=3 --output_dir="/user-volume/Reward_only/temp"
