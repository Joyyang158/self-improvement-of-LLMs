...
parser.add_argument('--input_dir', type=str, default='generated/zephyr-7b-sft-full/iter0_candidate')
...
for i in range(num_fracs):
    ...
    for json_str in json_list:
        ...
        for j in range(args.num_return_sequences):
            result['generated'][1]['content'][j] = result['generated'][1]['content'][j].lstrip()
        data.append(result)
