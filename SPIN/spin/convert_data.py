...
with open(f'{input_dir}/synthetic/train.json', 'w') as f:
    json.dump(data, f, indent=4)
with open(f'{input_dir}/synthetic/test.json', 'w') as f:
    json.dump(test_data, f, indent=4)

dataset = load_dataset('json', data_files=f'{input_dir}/synthetic/train.json',split='train')
dataset_test = load_dataset('json', data_files=f'{input_dir}/synthetic/test.json',split='train')
