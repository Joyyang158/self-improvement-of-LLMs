...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=6 --main_process_port 2950 spin/run_spin.py configs/config_llama-7b_ultrachat_reproduce.yaml --num_train_epochs=3 --output_dir="/group-volume/haoyan/spin_results/Llama-2-7b-ultrachat200k/reproduce_outputs/iter1-ckpt"
