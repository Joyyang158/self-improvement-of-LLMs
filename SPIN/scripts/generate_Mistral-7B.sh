...
do   
    ...
    accelerate launch --num_processes 1 --main_process_port=2950 spin/generate.py --model mistralai/Mistral-7B-v0.1 --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/Mistral-7B-Instruct-v0.1/iter0/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 1 --main_process_port=2950 spin/generate.py --model mistralai/Mistral-7B-v0.1 --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/Mistral-7B-Instruct-v0.1/iter0/test-raw-generated
