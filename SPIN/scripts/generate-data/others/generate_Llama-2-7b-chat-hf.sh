...
do   
    ...
    accelerate launch --num_processes 4 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/spin_results/Llama-2-7b-chat-hf/outputs/iter2-ckpt" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/Llama-2-7b-chat-hf/iter3/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 4 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/spin_results/Llama-2-7b-chat-hf/outputs/iter2-ckpt" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/Llama-2-7b-chat-hf/iter3/test-raw-generated
