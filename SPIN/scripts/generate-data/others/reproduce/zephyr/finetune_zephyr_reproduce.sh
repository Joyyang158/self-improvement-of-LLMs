...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=4 --main_process_port 2950 spin/run_spin.py configs/config_zephyr_reproduce.yaml --num_train_epochs=3 --output_dir="/group-volume/haoyan/spin_results/zephyr-7b-sft-full/reproduce_outputs/iter1-ckpt_again"
