...
do   
    ...
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "Deci/DeciLM-7B-instruct" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/DeciLM-7B-instruct/iter0/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "Deci/DeciLM-7B-instruct" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/DeciLM-7B-instruct/iter0/test-raw-generated
