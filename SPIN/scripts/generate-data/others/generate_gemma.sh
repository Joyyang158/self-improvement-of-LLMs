...
do   
    ...
    accelerate launch --num_processes 2 --main_process_port=2950 spin/generate.py --model "google/gemma-2b" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/gemma-2b/iter0/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 2 --main_process_port=2950 spin/generate.py --model "google/gemma-2b" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/gemma-2b/iter0/test-raw-generated
