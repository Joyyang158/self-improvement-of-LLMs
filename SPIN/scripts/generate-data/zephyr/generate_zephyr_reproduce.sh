...
do   
    ...
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/spin_results/zephyr-7b-sft-full/reproduce_outputs/iter1-ckpt_iterative" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/zephyr-7b-sft-full-reproduce/iter2/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/spin_results/zephyr-7b-sft-full/reproduce_outputs/iter1-ckpt_iterative" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/zephyr-7b-sft-full-reproduce/iter2/test-raw-generated
