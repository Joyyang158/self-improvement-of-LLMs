...
do   
    ...
    accelerate launch --num_processes 4 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/sft_results/Llama-2-7b-ultrachat200k/outputs_generated/iter0/final" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/Llama-2-7b-ultrachat200k-sft-generated/iter0/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 4 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/sft_results/Llama-2-7b-ultrachat200k/outputs_generated/iter0/final" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/Llama-2-7b-ultrachat200k-sft-generated/iter0/test-raw-generated
