...
# /group-volume/haoyan/models/Phi-3-mini-4k-instruct
# /group-volume/haoyan/models/gemma-1.1-2b-it
# alignment-handbook/zephyr-7b-sft-full


accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=4 --main_process_port 2950 spin/run_spin.py configs/config_phi.yaml --num_train_epochs=3 --output_dir="/group-volume/haoyan/spin_results/Phi-3-mini-4k-instruct/outputs/iter0-ckpt"
