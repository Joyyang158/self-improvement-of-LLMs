...
accelerate launch --num_processes 6 --main_process_port=2950 SPIN/spin/KL-noise.py --input_dir /blue/yonghui.wu/sgao1/haoyan/data/gpt-score-zephyr-7b-sft-full --base_model joyfine/zephyr-7b-sft-full-SPIN-iter0 --spin_model /blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/trainable-noised-gpt-preference-0-outputs/iter1 --base_input_file iter1.csv --spin_input_file iter2.csv --output_file iter1.csv
accelerate launch --num_processes 6 --main_process_port=2950 SPIN/spin/KL-noise.py --base_model /blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/trainable-noised-gpt-preference-0-outputs/iter1 --spin_model /blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/self-trainable-noise-gpt-preference-0-outputs/iter2-new/checkpoint-1667 --base_input_file iter2.csv --spin_input_file iter3.csv --output_file iter2.csv
accelerate launch --num_processes 6 --main_process_port=2950 SPIN/spin/KL-noise.py --base_model /blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/self-trainable-noise-gpt-preference-0-outputs/iter2-new/checkpoint-1667 --spin_model /blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/self-trainable-noise-gpt-preference-0-outputs/iter2 --base_input_file iter3.csv --spin_input_file iter4.csv --output_file iter3.csv
