...
do   
    ...
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/models/gpt-j-6b" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/gpt-j-6b/iter0/train-raw-generated
...
do 
    echo "Processing batch $DATA_FRAC of $NUM_BATCHEs..."
    accelerate launch --num_processes 7 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/models/gpt-j-6b" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --split test --output_dir generated/gpt-j-6b/iter0/test-raw-generated
