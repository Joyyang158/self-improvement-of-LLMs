...
#     accelerate launch --num_processes 4 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/models/stablelm-2-1_6b-chat" --batch_size 8 --frac_len $FRAC_LEN --data_frac $DATA_FRAC --output_dir generated/stablelm-2-1_6b-chat/iter0_candidate/train-raw-generated

# done
# echo "Train - All batches processed"


accelerate launch --num_processes 8 --main_process_port=2950 spin/generate.py --model "/group-volume/haoyan/models/stablelm-2-1_6b-chat" --batch_size 8 --frac_len $FRAC_LEN --data_frac 21 --output_dir generated/stablelm-2-1_6b-chat/iter0_candidate/train-raw-generated
