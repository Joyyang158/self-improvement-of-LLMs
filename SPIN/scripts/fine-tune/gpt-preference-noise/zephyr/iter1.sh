...
nohup accelerate launch --config_file SPIN/configs/deepspeed_zero3.yaml --num_processes=3 --main_process_port 2950 SPIN/spin/run_spin.py SPIN/configs/gpt-preference/zephyr/iter1.yaml --num_train_epochs=3 --output_dir="/blue/yonghui.wu/sgao1/haoyan/spin-results/zephyr-7b-sft-full/noised-gpt-preference-5-outputs/iter1" > job_output_noise.log 2>&1 &
