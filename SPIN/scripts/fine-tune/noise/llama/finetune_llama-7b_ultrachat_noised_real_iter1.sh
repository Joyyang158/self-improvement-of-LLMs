...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=8 --main_process_port 2950 spin/run_spin.py configs/config_llama-7b_ultrachat_noised_iter1.yaml --num_train_epochs=3 --output_dir="/group-volume/haoyan/spin_results/Llama-2-7b-ultrachat200k/noised_real_outputs/iter1-ckpt"
