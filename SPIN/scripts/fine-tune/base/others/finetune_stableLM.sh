...
accelerate launch --config_file configs/deepspeed_zero3.yaml --num_processes=4 --main_process_port 2951 spin/run_spin.py configs/config_stableLM.yaml --num_train_epochs=3 --output_dir="/group-volume/haoyan/spin_results/stablelm-2-1_6b-chat/information_filter/outputs/iter0-ckpt"
