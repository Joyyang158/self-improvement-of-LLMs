...
nohup accelerate launch --config_file SPIN/configs/deepspeed_zero3.yaml --num_processes=6 --main_process_port 2950 SPIN/spin/run_spin.py SPIN/configs/base/llama3-8b/iter1.yaml --num_train_epochs=3 --output_dir="/blue/yonghui.wu/sgao1/haoyan/spin-results/Llama-3-8B-Ultrachat-200K/SPIN/iter1" > SPIN_output_iter1.log 2>&1 &
